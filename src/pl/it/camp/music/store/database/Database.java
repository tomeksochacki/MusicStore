...
public class Database {
    ...
    //private List<Registration> list2 = new ArrayList<>(); NIEPOTRZEBNA LISTA JESZCZE NIE WYMYSLIŁEM DO CZEGO JEST
    //private File file = new File("databaseRegistration.txt"); NIE POTRZEBNA LISTA PÓKI CO BO NIE WRZUCAM NOWOUTWORZONYCH URZYTKOWNIKÓW DO PLIKU
    private List<User> users = new ArrayList<>();

    public Database() {

        this.list.add(new Gitara("Gitara basowa", 3, "0000", "instrument smyczkowy - basowy", 350.0, 4));
        this.list.add(new Gitara("Gitara elektroniczna", 4, "0001", "instrument smyczkowy - elektroniczny", 750.0, 6));
        this.list.add(new Gitara("Gitara klasyczna", 1, "0002", "instrument smyczkowy - klasyczny", 200.0, 5));
        this.list.add(new Trabka("Trąbka nowoczesna", 3, "0003", "instrument dęty", 400, 4, true));
        this.list.add(new Trabka("Trąbka klasyczna", 7, "0004", "instrument dęty", 550, 3, true));
        this.list.add(new Wzmacniacz("Wzmacniacz Tehnics", 0, "0005", "wzmacniacz", 1000, true, true, false, 300));
        this.list.add(new Wzmacniacz("Wzmacniacz Sony", 7, "0006", "wzmacniacz", 700, true, true, true, 200));
        this.list.add(new Wzmacniacz("Wzmacniacz Philips", 2, "0007", "wzmacniacz", 500, false, false, false, 170));
        this.list.add(new Perkusja("Perkusja Mapex", 1, "0008", "instrument perkusyjny", 1500, true, 8));
        this.list.add(new Perkusja("Perkusja Millenium", 10, "0009", "instrument perkusyjny", 800, true, 5));
...
/*public File getFile() {
    ...
    public User createUser(String yourLogin, String yourPassword, String yourName, String yourSureName, String yourAge, String yourPhoneNumber) {
        User user = new User(yourLogin,
                DigestUtils.md5Hex(yourPassword),
                yourName,
                yourSureName,
                yourAge,
                yourPhoneNumber);
